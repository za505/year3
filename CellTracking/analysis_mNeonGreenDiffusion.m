...
dirsave="/Users/zarina/Documents/MATLAB/MatlabReady/mNeonGreenDiffusion_analysis/10052021_analysis";
...
saveas(gcf,'09222021_length.png')
saveas(gcf, '09222021_length.fig')
...
saveas(gcf,'09222021_intensity.png')
saveas(gcf, '09222021_intensity.fig')
...
saveas(gcf,'09222021_norm_intensity.png')
saveas(gcf, '09222021_norm_intensity.fig')

% fit data to exponential function
cd(dirsave)

segment1=data_intensity(:, 1:11)./data_intensity(:, 1);
segment2=data_intensity(:, 12:32)./data_intensity(:, 12);
segment3=data_intensity(:, 33:end)./data_intensity(:, 33);
...
xlabel('Time (min)')
ylabel('Normalized Intensity (A.U.)')
saveas(gcf,['09222021_segment1_' num2str(coeff0) '.png'])
saveas(gcf, ['09222021_segment1_' num2str(coeff0) '.fig'])
...
xlabel('Time (min)')
ylabel('Normalized Intensity (A.U.)')
saveas(gcf,['09222021_segment2_' num2str(coeff0) '.png'])
saveas(gcf,['09222021_segment2_' num2str(coeff0) '.fig'])
...
xlabel('Time (min)')
ylabel('Normalized Intensity (A.U.)')
saveas(gcf,['09222021_segment3_' num2str(coeff0) '.png'])
saveas(gcf,['09222021_segment3_' num2str(coeff0) '.fig'])
...
saveas(gcf,['09222021_Exp1_tau.png'])
saveas(gcf,['09222021_Exp1_tau.fig'])
...
xlabel('Time (min)')
ylabel('Normalized Intensity (A.U.)')
saveas(gcf,['10022021_segment1_' num2str(coeff0) '.png'])
saveas(gcf, ['10022021_segment1_' num2str(coeff0) '.fig'])
...
xlabel('Time (min)')
ylabel('Normalized Intensity (A.U.)')
saveas(gcf,['10022021_segment2_' num2str(coeff0) '.png'])
saveas(gcf,['10022021_segment2_' num2str(coeff0) '.fig'])
...
xlabel('Time (min)')
ylabel('Normalized Intensity (A.U.)')
saveas(gcf,['10022021_segment3_' num2str(coeff0) '.png'])
saveas(gcf,['10022021_segment3_' num2str(coeff0) '.fig'])
