...
dirname=['/Users/zarina/Downloads/NYU/Year3_2021_Summer/07232021_analysis/' basename '_colony1/' basename '_TADA/' basename '_erased'];%Directory that the image stack is saved in.
savedir=['/Users/zarina/Downloads/NYU/Year3_2021_Summer/07232021_analysis/' basename '_colony1/' basename '_phase/' basename '_figures'];%Directory to save the output .mat file to.
...
IntThresh=25000;%Threshold used to enhance contrast. Default:35000
...
cd(savedir);
save([basename '_BTlab'],'labels', '-v7.3')
clear labels
